...
| --- | --- | --- | --- | --- | --- |
| 기능 / 검색 점검 | `read` | `/console/search` — 탭 3: 훈련 RAG · 생활 RAG(`/ask` + `/walk`) · 피부 스크리닝 | `/training/chat`(SEARCH_INSPECT) · `/ask` `/walk`(READ, 앱 회원도) · `/screen/v1/screen`(**무인증**) | ✅ #30 · #36 · #170 | 앱은 `/assistant/query` 만 부르는데 콘솔은 직접 API 만 두들긴다. 산책 기록 · gait · place · journey 탭 없음 |
