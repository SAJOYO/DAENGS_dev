...
| 훈련 RAG | dev 에 코드 없음 — 외부 URL (`DAENGS_TRAINING_RAG_BASE_URL`). 이관 미수행 (D-032) | v1 능력 셋 중 유일한 외부 의존 |
...
- **라우터 모델** — #80 §4 벤치마크 카드 (팀). `gemini-3.1-flash-lite` 는 **생성** 모델이고 라우터 선정 근거가 아니다.
