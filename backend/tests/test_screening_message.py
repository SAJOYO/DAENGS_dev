...
print("\n[2] 계열 네 묶음 전체 노출")
from daengs_screening.config import GROUP_FEATURE, MORPH_GROUP_KEEP_A6      # noqa: E402
...
from daengs_screening.config import GROUP_LABELS, MORPH_GROUP_KEEP_A6 as _MG   # noqa: E402
...
from daengs_screening.message import Prediction, compose_screening_message      # noqa: E402
