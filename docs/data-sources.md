...
| 펫보험 | 3 | 0 | **1** (`knia` 확인 완료 · 약관은 공시실) | knia 비교공시 + 보험사 약관 PDF |
| **문서형 소계** | **23** | **9** | **5** | |
...
- [x] ✅ **`knia-disclosure`** — 손해보험협회 · **펫보험 공시 있다** (2026-08-28 확인, #50)
...
- [ ] `knia-disclosure` — 반려동물보험 비교공시 (담보·지급사유·자기부담금. 약관보다 먼저 되는 쪽)
- [ ] `insurer-terms-pdfs` — 보험 약관 PDF (사별 AJAX 역추적이 선행)
