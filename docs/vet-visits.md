...
**축은 하나다 — "이 방문이 무엇을 겨눴나".** 답은 신체계통 열둘이거나, 예방 넷(겨누는 계통이
없다), 아니면 `other` 다. 축을 섞으면 한 방문에 코드가 둘씩 맞아떨어진다: 피부 종괴 제거가
...
**예방 4** — 겨누는 계통이 없어서 따로 선다.

| code | 표시명 | |
| --- | --- | --- |
| `vaccination` | 예방접종 | 종합백신, 광견병, 켄넬코프 |
...
중성화(`neuter`)와 자궁축농증(`reproductive`)도 같은 장기를 여는 수술이라 항목이 닮았다.
