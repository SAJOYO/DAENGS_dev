...
from daengs_place.geo.icons import IconGroup, icon_group
from daengs_place.geo.pet import accepting_size_classes
from daengs_place.geo.ranking import (
    DISTANCE_BAND_M,
    band_boost_sorted,
...
# 서버가 세우는 자원 경계. 다른 지도 조회의 결과 상한과 같은 이유다 —
...
class FacilitySearchOut(BaseModel):
    ...
    # 상한에 걸렸나. 다른 지도 조회와 같은 이유로 있다 — 조용히 자르면 "이 반경엔
