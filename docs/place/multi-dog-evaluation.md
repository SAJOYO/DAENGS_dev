...
```powershell
cd backend
uv run pytest -q tests/place/api/test_multi_dog_search.py tests/place/api/test_contract_validation.py tests/place/place/test_evaluations.py tests/place/place/test_restriction_projection.py tests/test_pets.py tests/test_pet_photo.py
```
