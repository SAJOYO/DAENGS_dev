...
| [walk-finalize-operating-db-smoke.md](walk-finalize-operating-db-smoke.md) | #140 finalize 운영 DB rollback smoke 결과 — 선행 `walk_point_chunks` migration 누락과 재검증 순서 |
