...
@pytest.mark.parametrize(
    ...
    [
        ...
        "daengs_backend.services.walk_background.catalogs.park",
        "daengs_backend.services.walk_background.catalogs.commerce",
        "daengs_backend.services.walk_background.catalogs.river",
    ],
)
