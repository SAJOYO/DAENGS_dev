-- =====================================================================
-- 2026-08-29_crawl_runs.sql
-- 크롤 실행 이력 (RAG-001 원칙 3 · RAG-047)
-- 이미 돌고 있는 DB 에 손으로 적용합니다. 여러 번 돌려도 안전합니다 (IF NOT EXISTS).
-- =====================================================================
...
-- 이미 이 테이블을 만든 뒤에 run_id 를 nullable 로 바꿨다. 여러 번 돌려도 안전하다.
ALTER TABLE crawl_runs ALTER COLUMN run_id DROP NOT NULL;
