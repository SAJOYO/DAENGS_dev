...
**0단계 — Nano Banana 2, 11장 약 $0.85 썼고 art 모드는 09-14 에 폐기.** full 모드 증거는 4장뿐(고친 프롬프트로는 2장, 그중 2K 1장 닮음 실패)이라 **full 로 몇 장 더 돌려야 판정이 선다.** 지금까지 확인된 것: 정면 사진이면 닮음 좋음, 무대 고정 프롬프트가 먹힘, 글자는 full 4/4 무사, 아바타 모델 성공 6/7. 상세는 `worklog.md`. 그 뒤 6번 — Qwen-Image-Edit-2511 비교 (fal 크레딧 필요).
