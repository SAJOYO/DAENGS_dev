...
기존 기록의 봉투가 바뀌지도 않는다. 자동 갱신/지역 확장은 [#399](regional-catalogs.md),
명시적 backfill은 이후의 별도 작업이다.
