...
def aggregate_results(
    *,
    ...
    ask = _general_ask(results)
    if ask is not None and route_plan.clarify is None:
...
def _general_ask(results: list[CapabilityResult]) -> ClarifyRequest | None:
