...
# 2026-08-28 갱신 — 운송약관 HTML 3건 (RAG-039). parsed 293건 기준. +118 = article 85 ·
# table 32 · heading 1. **서울교통공사가 해설이 아니라 조문형이라서** article 로 들어온다 —
# 시드의 `pdf-entry` 분류가 틀렸다는 것이 이 수에 들어 있다. heading 1 은 SRT 한 장짜리 안내다.
TOTAL = 4_411
BY_TYPE = {"article": 3465, "aside": 22, "heading": 109, "para": 266, "qa": 10, "table": 539}
...
def test_soft_cap_known_only(chunks: list) -> None:
    ...
    `제3조제1항` 둘은 서울교통공사 약관의 정의 조다(1~8호선 3,647자 · 9호선 3,633자, RAG-039 ④).
