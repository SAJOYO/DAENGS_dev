...
- **콘솔이 운영 도구로 넘어왔다.** 메뉴 여덟 가운데 둘(기능 점검 · 크롤)만 여전히 "우리 기능을 우리가 두들겨
  본다" 이고, 나머지는 운영 화면이다 — 상태(#180) · 관리자 계정(#207 · #222) · 감사 로그(#221) ·
  회원 · 반려견(#211 · #212) · 운영 지표(#223). **준비 중 카드는 지식 베이스 하나만 남았고**, 그것은
  지금 성립하지 않는다 (§6). **사용자가 남긴 것 가운데 아직 없는 것은 신고 하나**다 (§3).
...
- **첫 카드는 신고가 아니라 그 앞의 것들이었다.** 감사 로그(#203) · 역할별 계정 발급(#207) · 회원 조회(#211 ·
  #212) · 감사 화면(#221)이 끝났고, 마지막 전제였던 **관리자가 회원 대화를 보는 범위**도 D-053 으로 닫혔다.
  **A1 을 막는 것은 이제 없다** — 마지막까지 남아 있던 "운영 DB 적용" 은 2026-09-05 에 확인해 보니
  **이미 끝나 있었다** (§2 "운영 DB 실측"). 즉 A1 은 지금 착수할 수 있다 (§5).
...
A4 감사 로그 ✅ → A3 계정 관리 ✅ → A2a 회원 조회 ✅ → A2b 복호화·상태 변경 ✅
                                                        (A 트랙. A4 가 앞인 이유는 아래)
남은 A 트랙: A1 신고 · A5 보존   (A0 은 D-053 으로 닫혔다 — #227)
