...
그러면 상한은 소유가 아니라 **"내 방에 서는 아이 수"** 여야 한다. 등록 · 초대 수락 · 승계
**세 곳**에서 구성원 기준(`count_accessible`)으로 검사한다. 승계에서만 보면 아빠가 자기 강아지
5마리를 키우면서 초대를 수락해 6마리가 되는 길이 열린다.
