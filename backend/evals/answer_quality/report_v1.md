...
**① D-057 ③ⓑ — 복합 발화에서 돌봄·응급 의도가 살아났다.** `general` 도달 35 → **68/84** (v2 = v3).
...
**② D-057 ③ⓐ — 과잉 거절이 사라졌다.** general_care 에서 `general` 이 거절한 것 7 → 0 (v2) → 1 (v3).
...
**결론 (D-057 ③ 에 대한 답).** 승인 조건 ⓐ·ⓑ 는 실측으로 충족됐고, 영문 v3 는 v2 와 동등하다. 남는 문제는
