...
from daengs_walk.diary.contracts.input import UserRecord, digest
from daengs_walk.diary.contracts.output import BackgroundPiece
from daengs_walk.diary.space.projection import Projection
...
def project_public_background(saved, core):
    ...
    try:
        if saved.provider in {"data-go-kr-commerce", "egis-rivers"}:
            from daengs_walk.diary.space.area import project_area
