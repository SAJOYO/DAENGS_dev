...
| 펫보험 | 3 | **2** (knia 110 + 3사 약관 5,019청크) | 1 (남은 4사) | knia 비교공시 + 보험사 약관 PDF |
| **문서형 소계** | **23** | **15** | **2** | |
...
2. ⚠️요확인 9건 → **2건.** 접종 2. **항공사는 2026-08-30 (#57) 에 끝났다** — 받을 수 있는 2곳을 다 받았다. **운송 3건은 2026-08-28 (#49 · #51) 에 다 수집됐다** —
...
- [x] ✅ **`airlines-pet-pages`** — 항공사 9곳 중 **2곳 수집 완료** (2026-08-30, RAG-046 · #57).
      에어프레미아 4,652자 · 이스타 4,395자 → **21청크**(heading 6 · table 15) 적재 완료.
