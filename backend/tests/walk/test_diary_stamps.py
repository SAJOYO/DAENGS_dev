...
from daengs_walk.diary_input import DiaryInput, SavedBackground, digest, material_ref
from daengs_walk.diary_output import assemble_diary
from daengs_walk.diary_stamps import StampPolicy, prepare_stamps
from tests.walk.test_diary_contract import observation, record, source
from tests.walk.test_walk_photo_input import (
    OWNER,
    WALK,
    context_envelope,
    entry,
