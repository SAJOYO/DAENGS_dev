      ...
      {creating && (
        ...
        >
          ...
          {/*
            ...
            **받은 사람은 `/console/password` 에서 바꿉니다** (#222). 강제하지는 않으므로
            (컬럼이 하나 늘고 두 DB 에 손 적용이 붙습니다 — 2026-09-04 사람 결정), 전달할
            때 "바꿔 주세요" 를 같이 말해야 초기 비밀번호가 팀 채널에 남지 않습니다.
          */}
          <p className="text-xs text-zinc-500 dark:text-zinc-400">
            초기 비밀번호는 발급한 사람이 본인에게 직접 전달합니다. 메일로 나가지 않습니다.
            받은 사람은 헤더의 이름을 눌러 스스로 바꿀 수 있습니다.
          </p>
