...
from tests.test_walk_entry_v2 import OWNER, WALK
from tests.test_walk_entry_v2_db import database  # noqa: F401 -- transitive shared fixture
from tests.test_walk_photo_db import (  # noqa: F401 -- shared fixture
    photo_database,
    publish,
    request,
)
...
async def test_late_generation_cannot_replace_a_new_photo_snapshot(photo_database, monkeypatch):  # noqa: F811
