...
판정 gpt-5.4-2026-03-05 · profile-fitness-diff-ko-v2.1a · 생성 gemini-3.1-flash-lite (general-answer-ko-v6) · 2026-09-11T08:34:46+00:00
...
- 쌍 46 중 판정 22 · 판정 전 제외 {'missing_cell': 18, 'out_of_scope': 4, 'not_answered': 2} · 위치 뒤집힘 0/0 (양방향 본 쌍 중) · 기권 0 → 미측정 비율 **0.522**
- 패러프레이즈 일치: None (0쌍)
