...
| 동반 이동 | 4 | **3** (코레일 + 서울교통공사 2문서 + SRT) | 1 (항공사 — **9곳 중 2곳만 수집 가능**) | SRT 반려동물 안내 + 서울교통공사 약관 |
...
4. **robots.txt 차단** — `animal.go.kr`(§2) · `qia.go.kr`(§3) · `e-insmarket`(§7) ·
   **현대해상 공시실**(§7 — 펫보험 **8상품**으로 2위 판매사인데 약관을 못 받는다.
   ...
   같은 기관이라 허가를 받으려면 한 번에 물어야 한다. **항공사는 9곳 중 2곳만 수집 가능하다** —
   8/28 에 "5곳" 이라고 적은 것은 robots 만 본 값이고, 8/29 에 실제로 받아 보니 셋이 더 막혔다 (§5 · §12)
...
- [ ] ◐ **`airlines-pet-pages`** — 항공사 9곳 · **2곳만 수집 가능** (2026-08-29 실측, #57).
