"""판정기 — 루브릭 절대 채점 · 쌍대 비교 · 앵커 검사 (#277).
    ...
    uv run python -m daengs_evals.answer_quality.judge list-models
    uv run python -m daengs_evals.answer_quality.judge check-anchors --judge-model gemini-3.1-flash-lite
    uv run python -m daengs_evals.answer_quality.judge score --answers evals/answer_quality/answers_on.jsonl
    uv run python -m daengs_evals.answer_quality.judge score --answers ... --variants A B --subsample 30 \\
        --judge-model auto --out evals/answer_quality/judgments_on_agreement.jsonl
    uv run python -m daengs_evals.answer_quality.judge pairwise --a answers_off.jsonl --b answers_on.jsonl
...
from daengs_evals.answer_quality.anchors import ANCHORS, check_anchors
...
from daengs_evals.answer_quality.screening_rubric import (
