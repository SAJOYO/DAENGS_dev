...
**2026-09-14 #520 후속:** [공간 맥락 조립](diary-space-scene.md)이 아래 2.2·2.5절의
의미 구분 중 현재 자료로 확인 가능한 부분을 구현한다. 대상 간 형상 관계·최종 공간 분류 위계의
완료를 뜻하지 않는다. 행동 핀 조건은 [제품 규칙 복구](diary-action-boundary.md), 동행의 공간
등장 허용은 [보호자 시점](diary-narration.md)이 아래 과거 기록보다 최신이다.
