...
from .diary_board_selection import _route
from .diary_input import Point, digest
from .diary_route_patterns import normalize_route_patterns
...
def prepare_route_patterns(source, route, policy):
    if route is None:
        return None
    _, _, revision = _route(source, route)
