"""계층마다 질문을 생성해 동결한다 (#277).
    ...
    uv run python -m tools.answer_quality.generate_questions --strata general_care --dry-run
    uv run python -m tools.answer_quality.generate_questions            # 전 계층 → questions_v1.jsonl
