...
4지점은 `docs/life/realtime-apis.md` §6.5 에서 실제로 대조한 것이다. 여기 박아 두는 이유는
...
from daengs_life.realtime.geo import Grid, LatLon, haversine_km, nearest, same_grid, to_grid, to_latlon
