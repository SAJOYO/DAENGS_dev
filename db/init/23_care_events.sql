...
-- 같이 보여 줄 뿐이다.
--
-- **비서가 이 표를 읽고, 쓴다.** 읽기는 #344 (건수·마지막 시각만 프롬프트로), 쓰기는 D-075 다.
-- 2026-09-08 의 사람 결정("채팅으로 기록하는 쓰기 능력은 처음부터 안 한다")은 2026-09-14 에
...
-- 없어서 서버의 제안 id 가 그 자리에 온다 (D-075). 유일성은 어느 쪽이 만들어도 아래 UNIQUE 가
-- 보장한다.
--
