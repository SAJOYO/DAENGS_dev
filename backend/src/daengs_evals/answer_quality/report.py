"""`report_v1.md` · `summary_v1.json` — 디렉터리의 파일에서 결정론으로 (#277).
    ...
    uv run python -m daengs_evals.answer_quality.report --note "쌍대는 예산으로 안 돌림 — ..."
...
from daengs_evals.answer_quality.collect import NOT_ANSWERED_STATUSES, load_answers
from daengs_evals.answer_quality.judge import (
    RUBRIC_ITEMS,
    RUBRIC_MAX,
    agreement_rates,
    pairwise_summary,
...
from daengs_evals.answer_quality.questions import ASSETS_DIR, file_sha256, load_questions
from daengs_evals.answer_quality.strata import STRATA, STRATA_BY_ID
